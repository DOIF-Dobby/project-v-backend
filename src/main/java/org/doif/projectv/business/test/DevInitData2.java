...
public class DevInitData2 {
    ...
    static class DevInitDataService {
        ...
        @Transactional
        public void init() {
            Page page = em.find(Page.class, 7L);
            Role role = em.find(Role.class, 1L);



            Button button = new Button("조회", "페이지 자원 조회 버튼", EnableStatus.ENABLE, "BTN_RESOURCE_PAGE_FIND_BY_TAB", "/api/resources/pages", HttpMethod.GET, page, "");
