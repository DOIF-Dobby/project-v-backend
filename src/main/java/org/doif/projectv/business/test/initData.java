...
public class initData {
    ...
    static class InitDataService {
        ...
        public void init() {
            ...
            MenuCategory menuCategory = new MenuCategory(ResourceStatus.ENABLE,1, "heart");
            Menu menu = new Menu(ResourceStatus.ENABLE, "/project", GET, menuCategory, 1);
            Page page = new Page(ResourceStatus.ENABLE, "/api/pages/project", GET);
            Button button1 = new Button(ResourceStatus.ENABLE, page, "/api/project", GET);
            Button button2 = new Button(ResourceStatus.ENABLE, page, "/api/user", POST);
            Button button3 = new Button(ResourceStatus.ENABLE, page, "/api/project/{id}", PUT);
            Button button4 = new Button(ResourceStatus.ENABLE, page, "/api/task", GET);
            Button button5 = new Button(ResourceStatus.ENABLE, page, "/api/svn", GET);
            Button button6 = new Button(ResourceStatus.ENABLE, page, "/api/version/release/{id}", PUT);
            Button button7 = new Button(ResourceStatus.ENABLE, page, "/api/version", POST);
            Button button8 = new Button(ResourceStatus.ENABLE, page, "/api/version", GET);
