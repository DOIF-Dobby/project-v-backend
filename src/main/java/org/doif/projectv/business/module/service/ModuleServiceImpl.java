...
public class ModuleServiceImpl implements ModuleService {
    ...
    public CommonResponse insert(ModuleDto.Insert dto) {
        ...
        Module module = new Module(dto.getModuleName(), project, dto.getDescription(), dto.getVcsType(), dto.getVcsRepository(), dto.getBuildTool());
    ...
    public CommonResponse update(Long id, ModuleDto.Update dto) {
        ...
        module.changeModule(dto.getModuleName(), dto.getDescription(), dto.getVcsType(), dto.getVcsRepository(), dto.getBuildTool());
