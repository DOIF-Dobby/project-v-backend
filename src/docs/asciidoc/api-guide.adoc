...
include::{snippets}/label/select/request-fields.adoc[]
===== 응답
...
include::{snippets}/tab/select/request-fields.adoc[]
===== 응답
...
include::{snippets}/button/select/request-fields.adoc[]
===== 응답
...
include::{snippets}/role-resource/select-page/request-fields.adoc[]
===== 응답
...
include::{snippets}/role-resource/select-button/request-fields.adoc[]
===== 응답
...
include::{snippets}/role-resource/select-tab/request-fields.adoc[]
===== 응답
...
include::{snippets}/user-role/select/request-fields.adoc[]
===== 응답
...
include::{snippets}/user/select/request-fields.adoc[]
===== 응답
...
include::{snippets}/page-child/select/path-parameters.adoc[]
===== 응답
